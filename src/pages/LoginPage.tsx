          ...
          <div className="text-center mb-8">
            <div className="mx-auto w-16 h-16 rounded-xl bg-slate-900 flex items-center justify-center shadow-lg shadow-slate-900/20 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M13 3H12V11L9.75 8.75L8.33333 10.1667L12 14L16 10L13 13V3Z" />
                <path d="M19 12C19 15.866 15.866 19 12 19C8.13401 19 5 15.866 5 12C5 8.13401 8.13401 5 12 5C15.866 5 19 8.13401 19 12Z" />
              </svg>
            </div>
            <h1 className="text-2xl font-black text-slate-900">مرحباً بك في Lahlah OS</h1>
            <p className="text-slate-500 font-bold mt-2">الرجاء تسجيل الدخول لبدء استخدام النظام</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm font-bold text-slate-700">
                  تذكرني
                </label>
              </div>
              
              <div className="text-sm">
                <Link to="/forgot-password" className="font-bold text-slate-600 hover:text-slate-900">
                  هل نسيت كلمة المرور؟
                </Link>
              </div>
            </div>
